...
@LargeTest
public class SessionDetailActivityTestLiveSession {
   ...
   @Test
    ...
    /**
     * Fakes data for a session not in user schedule, not keynote, with live stream, no feedback,
     * ready for feedback,1 speaker, 2 tags, and a youtube link.
     */
    public static class FakeSessionDetailModelLive extends SessionDetailModel {

        public FakeSessionDetailModelLive(Uri sessionUri, Context context,
